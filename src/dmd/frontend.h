...
public:
    ...
    virtual void visit(AttributeInitExp* e);
...
class AttributeInitExp final : public DefaultInitExp
{
public:
    Expression* resolveLoc(const Loc& loc, Scope* sc);
    void accept(Visitor* v);
